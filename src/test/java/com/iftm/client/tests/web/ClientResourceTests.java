...
public class ClientResourceTests {
	...
	/* insert deveria retornar “created” (código 201), bem como um produto criado, quando os dados forem válidos */
	@Test
	public void insertShouldReturnCode201AndClientDTOWhenIdExists() throws Exception {
	...
	/* update ○ retornar “ok” (código 200), bem como o produto atualizado para um id existente */
	@Test
	...
	/* retornar “not found” (código 204) quando o id não existir. Fazer uma assertion para verificar no json de 
	 * retorno se o campo “error” contém a  string “Resource not found” */
	@Test
